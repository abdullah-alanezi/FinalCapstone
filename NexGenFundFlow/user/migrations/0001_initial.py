# Generated by Django 4.2.7 on 2023-12-28 08:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='StartupManagerProfile',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('position', models.CharField(max_length=255)),
                ('manager_phone_number', models.CharField(max_length=10)),
                ('manager_avatar', models.ImageField(default='images/default.jpg', upload_to='images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inverstor_avatar', models.ImageField(default='images/default.jpg', upload_to='images/')),
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user_investor_profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
